...
public class adapter extends RecyclerView.Adapter<adapter.myViewHolder> {
    ...
    public void onBindViewHolder(myViewHolder holder, final int position) {
        ...
        holder.barberaddress.setText(barber.get(position).address);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context , barber_reserve.class);
    ...
    public void senddata(int position) {
        Barber send = barber.get(position);
        SharedPreferences prefs = context.getSharedPreferences("data", 0);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString("id", barber.get(position).id);
        editor.putString("shop", barber.get(position).shop);
        editor.putString("address", barber.get(position).address);
        editor.putString("takhfif", barber.get(position).takhfif);
        editor.apply();
    }
}