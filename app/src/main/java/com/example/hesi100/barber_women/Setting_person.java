...
/**
 * Created by hesi100 on 5/17/2018.
 */

public class Setting_person {
    public static void setTheme(LinearLayout L) {
        SharedPreferences prefs = app.context.getSharedPreferences("woman", 0);
        String theme=prefs.getString("theme","no");
        if(theme.equals("no"))
        {
            L.setBackground(app.context.getResources().getDrawable(R.drawable.back_ping));
        }
        else
        {
