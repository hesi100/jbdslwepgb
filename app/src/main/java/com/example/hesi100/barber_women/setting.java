...
public class setting extends AppCompatActivity {
    ...
    private void load()
    {
        ...
        int ostan=prefs.getInt("ostan", 0);
        int shahr= prefs.getInt("shahr", 0);
        spinnerostan.setVerticalScrollbarPosition(ostan);
        tayinshahr(spinnershahr,ostan);
        spinnershahr.setVerticalScrollbarPosition(shahr);
    }
