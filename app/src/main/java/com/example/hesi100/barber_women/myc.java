...
public class myc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView status=(TextView) findViewById(R.id.status_reserved);
        status.setText("اتمام");
        ...
        Reservation reservatoin=new Reservation("10","20", "not");
        reservatoin.setOthers("-1");
        hair.setText(reservatoin.hair);
        haircolor.setText(reservatoin.haircolor);
        nakhon.setText(reservatoin.nakhon);
        makeup.setText(reservatoin.makeup);
        abro.setText(reservatoin.abro);
        eplasion.setText(reservatoin.eplasion);
        nazar.setText(reservatoin.comment);
        ...
        for(int k=0;k<reservatoin.puan;k++)
        {
           im[k].setImageResource(R.drawable.fill_star);
        }

        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        price.setText(" هزینه "+reservatoin.cost+" تومان ");
